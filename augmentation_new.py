# -*- coding: utf-8 -*-
"""
Created on Sun May 26 21:36:27 2019
...
def Make_Data(input_dir, name):
    #path = os.path.expanduser(input_dir)
    #img_path = os.path.join(path, path.split("/")[-1] + ".gif")
    img_path = input_dir
    face_temp = Augmentation(img_path)
    aug_img = augImageClass(name, face_temp)
